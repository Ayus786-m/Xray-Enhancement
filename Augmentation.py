...
image_path = '/Users/ayusapurboo/Downloads/MD AYUS_20028296/MD AYUS_20028296 (SF)/xray_dataset/test/3/T3.png'
...
if image is None:
    ...
    # Define the augmentation sequence without the cutout
    seq = iaa.Sequential([
    ...
    augmented_images = seq(images=[image] * 10)  # Create 10 augmented images

    # Create red box outlines
